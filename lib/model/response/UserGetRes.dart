...
List<UserGetRespon> userGetResponFromJson(String str) =>
    List<UserGetRespon>.from(
        json.decode(str).map((x) => UserGetRespon.fromJson(x)));

String userGetResponToJson(List<UserGetRespon> data) =>
